...
from data.base_dataset import BaseDataset, get_transform, no_transform, get_transform_hsv, get_transform_lab, get_transform_saturation, get_transform_grayish
...
class AlignedDataset_Rand(BaseDataset):
    def initialize(self, opt):
        ...
        self.transform_sat = get_transform_saturation(opt)
        self.transform_gray = get_transform_grayish(opt)
